package com.framework.hanason.enums;


import com.framework.hanason.domain.ResultData;
...
public enum ErrorCodeEnum {
    ...
    NOT_FOUND_AUTH_HEADER(90002, "未找到验证http请求头"),
    ...
    public static ResultData err(ErrorCodeEnum errorCodeEnum) {
        return ResultData.err(errorCodeEnum.code, errorCodeEnum.msg);
    }
